...
if ($hero) :
    ...
    <div class="jumbotron bg-cover text-white single-post"
        ...
        <div class="container <?php echo $text_align_class; ?>">
            ...
            <?php if ($categories[0]->term_id !== 1) { ?>
            <div class="text-center">
                <p class="dib date-published font-weight-bold text-white">Posted In: <em><?php echo $categories[0]->name; ?></em></p>
            </div>
            <?php } ?>
            ...
            foreach ($dates as $key => $val) {
                $published_read .= '<p class="text-white font-weight-bold"><i class="fas fa-calendar-week pr-1"></i> ' . ucwords($key) . ': ' . $val . '</p>';
            }
            echo $published_read;
            ?>
