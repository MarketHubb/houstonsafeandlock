<div class="container py-24">
    <div class="row justify-content-between">
        ...
        <div class="col-md-7">
            ...
            <p class="lead mb-6">We deliver up to 100 miles from our location in Houston</p>
            <div class="row">
                <div class="col-md-4">
                    <ul class="list-group ms-4 ms-md-0">
                        <li>Galveston, TX</li>
                        <li>Southside Place, TX</li>
                        <li>Museum District, TX</li>
                        <li>Pasadena, TX</li>
                        <li>Friendswood, TX</li>
                        <li>Fresno, TX</li>
                        <li>League City, TX</li>
                        <li>Deer Park, TX</li>
                        <li>South Houston, TX</li>
                        <li>Clear Lake, TX</li>
                    </ul>
                </div>
                <div class="col-md-4">
