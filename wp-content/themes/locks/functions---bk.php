...
add_rewrite_rule('^testblog/([^/]*)/?', 'index.php?testblog=testblog','top');
add_rewrite_rule( 'blogdetail/([^/]*)/?','index.php?pagename=blogdetail&blog_id_1=$matches[1]', 'top' );
//add_rewrite_rule( 'testblog/([^/]*)/([^/]*)/?','index.php?pagename=testblog&pgg=$matches[1]', 'top' );
...
function my_page_function() 
	{
		...
		if(isset($_REQUEST['view']) && $_REQUEST['view']=='testblog')
		{
		    wp_redirect( home_url( "/testblog/" ));
		   ///require('myblog.php');   exit;
		}
		elseif(isset($_REQUEST['view']) && $_REQUEST['view']=='testblog' && isset($_REQUEST['page']))
		{
		    wp_redirect( home_url( "/testblog/" ).$_REQUEST['page']."/");
		   ///require('myblog.php');   exit;
		}
...

		{
			 ...
			 wp_redirect( home_url( "/blogdetail/" )."/".$_REQUEST['blogdetail']."/");
			 exit;
